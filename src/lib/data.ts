...
export const experience = [
  {
    ...
    highlights: [
      "Develop Java 21 and Spring Boot microservices for retail credit workflows, implementing REST APIs, business logic, and database integrations across distributed backend services.",
      "Build secure RESTful APIs for payment processing and customer onboarding workflows using Spring Security, OAuth 2.0, and JWT, reducing authentication-related support issues by 25%.",
      "Enhance customer-facing banking experiences using React.js and TypeScript, reducing frontend load times by nearly 20% through reusable, performance-optimized UI components.",
      "Improve PostgreSQL query performance by optimizing complex SQL queries and indexing strategies, reducing reporting execution times by nearly 25%.",
      "Develop event-driven backend workflows using Apache Kafka to enable asynchronous communication between payment, notification, and transaction-processing services, improving system scalability and service decoupling.",
      "Deploy and manage containerized backend services using Docker and Kubernetes in AWS environments, improving deployment consistency and streamlining application releases across multiple environments.",
      "Automate CI/CD workflows using Jenkins, reducing manual deployment effort by 40% and improving release consistency across development and production environments.",
      "Integrate OpenAI APIs into document-processing workflows to automate content generation and reduce repetitive manual support effort by nearly 30%.",
      "Collaborate with product managers, QA teams, and senior engineers during Agile sprints while expanding automated test coverage using JUnit 5 and Mockito, reducing regression risks and improving release quality.",
    ],
  },
  {
    company: "Deloitte",
